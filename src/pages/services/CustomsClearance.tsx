...
const CustomsClearance = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Breadcrumb */}
        <ServiceBreadcrumb serviceName="Customs Clearance" />
              ...
              {mainServices.map((service, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="font-bold text-primary text-sm mb-2">{service.title}</h3>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-accent/5 rounded-xl p-5"
              >
                <div className="flex items-center gap-3 mb-3">
                  <Globe className="w-5 h-5 text-primary" />
                  <h3 className="text-lg font-bold text-primary">Import Clearance</h3>
                </div>
                <p className="text-muted-foreground text-sm mb-3">
                  Our import clearance services streamline the process of bringing goods into the country.
                </p>
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <Globe className="w-5 h-5 text-primary" />
                  <h3 className="text-lg font-bold text-primary">Export Clearance</h3>
                </div>
                <p className="text-muted-foreground text-sm mb-3">
                  Our export clearance services ensure your goods leave efficiently with all documentation met.
                </p>
                <ul className="space-y-2">
        ...
        <section className="py-12 bg-primary">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-3">Need Customs Clearance Assistance?</h3>
