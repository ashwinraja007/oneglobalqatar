...
import { CheckCircle, Target, Eye, Heart, Shield, Lightbulb, Users } from 'lucide-react';
  ...
  const coreValues = [
    {
      icon: Shield,
      title: 'Integrity',
      description: 'We conduct business with honesty and transparency, building lasting trust with our partners.',
    },
    {
      icon: Heart,
      title: 'Reliability',
      description: 'Consistent, dependable service delivery that our clients can count on every time.',
    },
    {
      icon: Lightbulb,
      title: 'Innovation',
    ...
    },
    {
      icon: Users,
      title: 'Partnership',
      description: 'We believe in building strong, long-term relationships with our clients and agents.',
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <h2 className="text-2xl md:text-4xl font-bold text-primary mb-6">
                  Drive Your Business Forward with <span className="text-accent">OGL</span>
                </h2>
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
                  ...
                  <p>
                    We at OGL have a well experienced and established team with relevant experience in their own dedicated trade lanes supporting our customers with all their special requirements with complete dedication and transparency.
                  </p>
                  <p>
                  ...
                  <p>
                    We are well positioned to manage your LCL business with full attention. We aim to provide secured end to end LCL services to the Freight Forwarding/Logistics Companies in Qatar, ensuring to maintain the trust and not entertain direct customer business.
                  </p>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To be recognized as the most trusted and innovative NVOCC operator globally, setting new standards in logistics excellence and customer satisfaction. We envision a future where seamless global trade connects businesses and communities worldwide.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To provide cost-effective, reliable, and transparent LCL consolidation services to our partners worldwide. We are committed to delivering exceptional value through our dedicated trade lanes, experienced team, and unwavering focus on customer satisfaction.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-4xl font-bold text-primary mb-4">Our Core Values</h2>
